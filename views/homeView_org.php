...
?>
                        試算表期日：<input type="date" name="to" value="<?= h($dto->to ) ?>" required>
<?php               }
...
?>
                        開始日：<input type="date" name="from" value="<?= h($dto->from) ?>" required>
                        終了日：<input type="date" name="to" value="<?= h($dto->to ) ?>" required>
<?php
                    };
                }
?>
