...
class VoucherValidate {
    // VAddValidator の機能
    public function validateAdd(VAddDTO $dto): array {
        $errors = [];
    ...
    // VCreateValidator の機能
    public function validateCreate(VCreateDTO $dto): array {
        $errors = [];
    ...
    // VDeleteValidator の機能
    public function validateDelete(VDeleteDTO $dto): array {
        $errors = [];
